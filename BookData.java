...
*/
    public Book createBook(String title, String author, String publi, String year, String cat, String evalua) {
        ContentValues values = new ContentValues();
        Log.d("Creating", "Creating " + title + " " + author + " " + publi + " " + year + " " + cat + " " + evalua);

        // Add data: Note that this method only provides title and author
        // Must modify the method to add the full data
        values.put(MySQLiteHelper.COLUMN_TITLE, title);
        values.put(MySQLiteHelper.COLUMN_AUTHOR, author);
        values.put(MySQLiteHelper.COLUMN_PUBLISHER, publi);
        values.put(MySQLiteHelper.COLUMN_YEAR, year);
        values.put(MySQLiteHelper.COLUMN_CATEGORY, cat);
        values.put(MySQLiteHelper.COLUMN_PERSONAL_EVALUATION, evalua);
